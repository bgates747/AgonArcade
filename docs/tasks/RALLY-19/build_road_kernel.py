...
Field clearLeft(clearCoordinates,0,s16,0,0); Field clearRight(clearCoordinates,2,s16,319,319);
Field clearRoadTop(clearCoordinates,4,s16,104,104); Field clearRoadBottom(clearCoordinates,6,s16,223,223);
Field clearFooterTop(clearCoordinates,8,s16,224,224); Field clearFooterBottom(clearCoordinates,10,s16,239,239);
Set(clearRight,319); Set(clearRoadTop,104); Set(clearRoadBottom,223); Set(clearFooterTop,224); Set(clearFooterBottom,239);

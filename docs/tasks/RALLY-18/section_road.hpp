...
namespace rally {
// RALLY-18: nearest integer endpoints reserve the half-pixel quantization
// allowance explicitly. The matched live reference and lookup use this rule.
inline int sectionCentrePixel(int32_t q8) {
    return int(q8>=0?(q8+128)/256:-((-q8+128)/256));
}
